...
public class LaunchingClickMeUsingJavaWebstart {
	...
	by opening a web browser and navigating to the URL for the HTML page (in
	our example, http://www.lowewriter.com/ClickMe/ClickMe.html). Refer to
	Figure 1-2 to see how the page appears in the browser window.

	When the user clicks the Run the ClickMe application link, the dialog box shown
